          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                         <img src="/e-doctor/images/appointment-image.jpg" class="img-responsive" alt="">
                    </div>

                    <div class="col-md-6 col-sm-6">
                         <!-- CONTACT FORM HERE -->
                         <form id="register" role="form" method="post" action="addnewdoctor.php">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                 ...
                                 <div class="col-md-12 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" id="availabilty" name="availabilty" placeholder="availabilty">
                                   </div>
                                  
                                 

                                 <div class="col-md-12 col-sm-12">
                                        <label for="availabilty">Department</label>
                                        <input type="text" class="form-control" id="dept" name="dept" placeholder="Departmebnt">
                                   </div>
                                   ...
                                   <div class="col-md-12 col-sm-12">
                                        ...
                                        <button type="submit" class="form-control" id="cf-submit" name="submit">Add Doctor</button>
                                   </div>
                              </div>
                        </form>
                    </div>
